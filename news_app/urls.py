...
from .views import news_list, news_detail, homePageView, ContactPageView,aboutPageView,custom_404, HomePageView, \
...
urlpatterns = [
    ...
    path('page-404/', custom_404, name='page-404'),
    ...
    path('Spotr/', SportNewsView.as_view(), name='sport_news_page'),
]